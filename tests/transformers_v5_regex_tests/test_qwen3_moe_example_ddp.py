"""
Test regex pattern matching for awq/qwen3_moe_example_ddp.py
...
@pytest.mark.unit
def test_qwen3_moe_example_ddp_regex_matching():
    """Test that regex patterns in qwen3_moe_example_ddp match expected modules."""
    import torch
