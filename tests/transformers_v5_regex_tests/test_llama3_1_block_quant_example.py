def test_llama31_fp8_block_example_regex_matching():
    """Test that regex patterns in quantization_w8a8_fp8/llama3.1_block_quant_example match expected modules.
