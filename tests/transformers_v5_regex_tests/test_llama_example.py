"""
Test regex pattern matching for awq/llama_example.py
...
@pytest.mark.unit
def test_llama_example_regex_matching():
    """Test that regex patterns in llama_example match expected modules."""
