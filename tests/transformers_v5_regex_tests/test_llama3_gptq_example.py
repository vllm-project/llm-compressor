def test_llama3_gptq_example_regex_matching():
    """Test that regex patterns in llama3_gptq_example match expected modules.

    Recipe targets: Linear (via config_groups)
