def test_llama4_dynamic_quant_example_regex_matching():
    """Test that regex patterns in quantization_w8a8_fp8/llama4_dynamic_quant_example match expected modules.
