"""
Test regex pattern matching for awq/w4a8_fp8_llama_example.py
...
@pytest.mark.unit
def test_w4a8_fp8_llama_example_regex_matching():
    """Test that regex patterns in w4a8_fp8_llama_example match expected modules."""
