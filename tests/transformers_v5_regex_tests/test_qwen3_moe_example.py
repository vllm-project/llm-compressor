"""
Test regex pattern matching for awq/qwen3_moe_example.py
...
@pytest.mark.unit
def test_qwen3_moe_example_regex_matching():
    """Test that regex patterns in qwen3_moe_example match expected modules."""
    import torch
