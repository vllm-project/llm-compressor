def test_gpt_oss_20b_example_regex_matching():
    """Test that regex patterns in gpt_oss_20b_example match expected modules.

    This test validates that:
    - lm_head is properly ignored (should not match when excluded)
    - Linear targets are properly matched
    """
    ...
    # Test with ignore pattern applied
