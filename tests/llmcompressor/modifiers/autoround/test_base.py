...
def tiny_llama_model():
    """Load the repository's tiny Llama checkpoint without downloading weights."""
    with skip_weights_download():
        return AutoModelForCausalLM.from_pretrained("nm-testing/tinysmokellama-3.2")


@pytest.fixture
def tiny_llama_decoder_layer(tiny_llama_model):
    return copy.deepcopy(tiny_llama_model.model.layers[0])
...
def test_get_unquantized_layer_names_matches_regex_targets(tiny_llama_decoder_layer):
    ...
    layer = tiny_llama_decoder_layer
