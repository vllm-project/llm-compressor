...
from compressed_tensors.quantization import QuantizationConfig, preset_name_to_scheme, apply_quantization_config
from huggingface_hub.errors import StrictDataclassError
from safetensors import safe_open
from transformers import AutoConfig, AutoModelForCausalLM, Qwen3VLMoeForConditionalGeneration, InklingForConditionalGeneration
...
@pytest.mark.parametrize(
    ...
    [
        ...
        #         "model.language_model.layers.0.mlp.experts.gate_up_proj_zero_point",
        #         "model.language_model.layers.0.mlp.experts.down_proj",
        #         "model.language_model.layers.0.mlp.experts.down_proj_scale",
        #         "model.language_model.layers.0.mlp.experts.down_proj_zero_point",
        #     ],
        # )
        (
...
def test_linearize_save(model_cls, model_stub, exp_keys):
    model = model_cls.from_pretrained(model_stub, device_map="cuda")
    linearize_moe(model)
    breakpoint()