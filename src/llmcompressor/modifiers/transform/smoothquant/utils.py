...
MAPPINGS_REGISTRY: dict[str, list[LayerMap]] = {
    ...
    "Ernie4_5MoeForCausalLM": QWEN_MOE_SMOOTHQUANT_MAPPINGS,
    ...
    "Qwen2_5OmniForConditionalGeneration": DEFAULT_SMOOTHQUANT_MAPPINGS,
    "Qwen2_5VLForConditionalGeneration": DEFAULT_SMOOTHQUANT_MAPPINGS,
