...
MAPPINGS_REGISTRY: dict[str, list[LayerMap]] = {
    ...
    "Qwen3_5ForCausalLM": DEFAULT_SMOOTHQUANT_MAPPINGS,
    "Qwen3_5ForConditionalGeneration": DEFAULT_SMOOTHQUANT_MAPPINGS,
    "Qwen3_5MoeForCausalLM": QWEN_MOE_SMOOTHQUANT_MAPPINGS,
    "Qwen3_5MoeForConditionalGeneration": QWEN_MOE_SMOOTHQUANT_MAPPINGS,
