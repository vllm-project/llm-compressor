...
import torch
from compressed_tensors.modeling.attention import register_query_hook
from compressed_tensors.modeling.kvcache import register_key_hook, register_value_hook
