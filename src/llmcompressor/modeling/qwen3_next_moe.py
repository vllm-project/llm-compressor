...
class Qwen3NextSparseMoeBlock(torch.nn.Module):
    def __init__(
        self, config: Qwen3NextConfig, original: OriginalQwen3NextMoeSparseMoeBlock
    ):
        super().__init__()
...
def replace(config: Qwen3NextConfig, module: OriginalQwen3NextMoeSparseMoeBlock):
    return Qwen3NextSparseMoeBlock(config=config, original=module)
