...
class WhisperEncoderPatched(WhisperEncoder):
    ...
    def forward(
        ...
        embed_pos = self.embed_positions(torch.arange(self.embed_positions.num_embeddings, device=inputs_embeds.device))  # PATCH: call embed_positions to trigger onloading
