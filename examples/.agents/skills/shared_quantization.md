...
Use the shared template at `examples/.agents/skills/templates/oneshot_with_data.py` as the starting point. Choose the dataset code based on what the user selected — **never ask the user to edit or delete code themselves**:
