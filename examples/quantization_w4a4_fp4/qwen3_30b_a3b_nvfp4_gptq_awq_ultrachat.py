...
# In this case, we:
#   * apply AWQ (activation-aware weight quantization) to preserve salient
#       weights based on activation magnitudes before quantization
...
SAVE_DIR = MODEL_ID.rstrip("/").split("/")[-1] + "-NVFP4-GPTQ-AWQ-ultrachat"
