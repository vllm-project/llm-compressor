"""
LongCat-2.0 NVFP4 (W4A4) Quantization

Quantizes LongCat-2.0 to NVFP4 (4-bit weights, 4-bit activations) via oneshot.
...
SAVE_DIR = os.path.join(HF_HUB_DIR, "LongCat-2.0-NVFP4-RTN")
