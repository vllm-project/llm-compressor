...
html_theme_options = {
    ...
    'repository_url': 'https://github.com/vllm-project/llm-compressor',
...
myst_url_schemes = {
    ...
    "gh-issue": {
        "url":
        "https://github.com/vllm-project/llm-compressor/issues/{{path}}#{{fragment}}",
        "title": "Issue #{{path}}",
        "classes": ["github"],
    },
    "gh-pr": {
        "url":
        "https://github.com/vllm-project/llm-compressor/pull/{{path}}#{{fragment}}",
    ...
    "gh-dir": {
        "url": "https://github.com/vllm-project/llm-compressor/tree/main/{{path}}",
        "title": "{{path}}",
        "classes": ["github"],
    },
    "gh-file": {
        "url": "https://github.com/vllm-project/llm-compressor/blob/main/{{path}}",
        "title": "{{path}}",
        "classes": ["github"],
    },
}
...
def get_repo_base_and_branch(pr_number):
    ...
    url = f"https://api.github.com/repos/vllm-project/llm-compressor/pulls/{pr_number}"
...
def linkcode_resolve(domain, info):
    ...
    return f"https://github.com/vllm-project/llm-compressor/blob/main/{filename}#L{lineno}"
