...
* **DeepSeek-V4-Flash and Kimi-K2.6 Quantized Checkpoints**: Quantized checkpoints for DeepSeek-V4-Flash and Kimi-K2.6 have been generated by the RedHat team and posted to the HF hub. For models quantized and published by the RedHat team, consider using:
