...
* **QuIP and SpinQuant-style Transforms**: The newly added [`QuIPModifier`](src/llmcompressor/modifiers/transform/quip/base.py) and [`SpinQuantModifier`](src/llmcompressor/modifiers/transform/spinquant/base.py)s allow users to quantize their models after injecting hadamard weights into the computation graph, reducing quantization error and greatly improving accuracy recovery for low bit weight and activation quantization.
