...
* **Llama4 Quantization Support**: Try quantizing a Llama4 model to [W4A16](examples/multimodal_vision/llama4_example.py) or [NVFP4](examples/quantization_w4a4_fp4/llama4_example.py). The saved checkpoint can seamlessly run in vLLM.
