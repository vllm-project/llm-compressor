...
* **Qwen3.6 NVFP4 Generated Checkpoint**: An [NVFP4 quantized checkpoint](https://huggingface.co/RedHatAI/Qwen3.6-35B-A3B-NVFP4) has been generated by the RedHat team and posted to the HF hub. Qwen3.6 follows the same architecture as Qwen3.5 so existing LLM Compressor examples can be used for model by swapping out the target model string
